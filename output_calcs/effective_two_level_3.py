...
filename='output_calcs/two_lvl_out3_n10'
deltamacvals=np.linspace(-1000e6,1000e6,30)
deltamvals=np.linspace(-600e6,600e6,30)
deltaoval=1e7
binval=50
p = {}
p['nbath']=10
...
p['freqmu'] = 5.186e9
p['freq_pump'] = 0#195113.36e9 #pump frequency
p['freqo']=195113.36e9 +5.186e9
