...
filename='Thesis_figs/Cavity_shifts/microwave_linear_excited_shift1'
#I_vals=np.linspace(7.43,7.55,31)
delta2vals=np.linspace(-2000e6,2000e6,25)/3
deltamucvals=np.linspace(-250e6,250e6,25)/1
...
gammamc_vals=np.linspace(0,1,20)*2*pi*10e8
gammaoc_vals=np.linspace(0,1,20)*2*pi*10e9

# gammamc_vals=np.linspace(0,1,10)*2*pi*1e12
# gammaoc_vals=np.linspace(0,1,10)*2*pi*1e6
...
img1=ax.imshow(10*np.log10(np.abs(Cab)**2),extent=(np.min(gammamc_vals),np.max(gammamc_vals),np.min(gammaoc_vals),np.max(gammaoc_vals)),aspect='auto',origin='lower')
...
img1=ax.imshow((np.abs(Cab)**2),extent=(np.min(gammamc_vals),np.max(gammamc_vals),np.min(gammaoc_vals),np.max(gammaoc_vals)),aspect='auto',origin='lower')
...
img1=ax.imshow((np.angle(Cab)),extent=(np.min(gammamc_vals),np.max(gammamc_vals),np.min(gammaoc_vals),np.max(gammaoc_vals)),aspect='auto',origin='lower',cmap='hsv')
...
ax=fig.add_subplot(3,1,1)
img1=ax.imshow(10*np.log10(np.abs(Cba)**2),extent=(np.min(gammamc_vals),np.max(gammamc_vals),np.min(gammaoc_vals),np.max(gammaoc_vals)),aspect='auto',origin='lower')
#plt.plot(deltamucvals,np.sqrt(p['Nm'])*p['gm']/deltamucvals)
plt.xlabel('gammamc')
plt.ylabel('gammaoc')
fig.colorbar(img1)
...
ax=fig.add_subplot(3,1,2)
img1=ax.imshow((np.abs(Cba)**2),extent=(np.min(gammamc_vals),np.max(gammamc_vals),np.min(gammaoc_vals),np.max(gammaoc_vals)),aspect='auto',origin='lower')
# plt.title('|bout/bin|^2')
plt.xlabel('gammamc')
plt.ylabel('gammaoc')
fig.colorbar(img1)
...
ax=fig.add_subplot(3,1,3)
img1=ax.imshow((np.angle(Cba)),extent=(np.min(gammamc_vals),np.max(gammamc_vals),np.min(gammaoc_vals),np.max(gammaoc_vals)),aspect='auto',origin='lower',cmap='hsv')
# plt.ylabel('atom delta')
plt.xlabel('gammamc')
plt.ylabel('gammaoc')
fig.colorbar(img1)
