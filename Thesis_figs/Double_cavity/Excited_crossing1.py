...
filename='Thesis_figs/Double_cavity/Excited_crossing1'
B_vals=np.linspace(0.226,0.238,11)
deltamvals=np.linspace(-25e6,25e6,11)*2*np.pi
# B_vals=np.linspace(0.226,0.238,21)
# deltamvals=np.linspace(0e6,25e6,3)*2*np.pi
P_pump = 10*np.log10(10.74/1) #in dBm, 1.74 mW are going into the resonator
P_mu = -15-30 # in dBm
T=400e-3
