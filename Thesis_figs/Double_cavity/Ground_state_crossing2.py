...
B_vals=np.linspace(0.205,0.218,151)
deltamvals=np.linspace(-100e6,100e6,151)*2*np.pi
...
filename='Thesis_figs/Double_cavity/Ground_state_crossing2_testwork_notopticalres'+ 'Pmu=' +str(P_mu)+ 'T='+str(T)
