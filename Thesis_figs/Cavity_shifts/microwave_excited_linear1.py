...
filename='Thesis_figs/Cavity_shifts/microwave_linear_excited_shift2'
#I_vals=np.linspace(7.43,7.55,31)
delta2vals=np.linspace(-2000e6,2000e6,15)
deltamucvals=np.linspace(-250e6,250e6,15)
delta2vals=np.linspace(-2000e6,2000e6,25)
deltamucvals=np.linspace(-250e6,250e6,25)
delta2vals=np.linspace(-1,1,125)*0.5e9
deltamucvals=np.linspace(-1,1,125)*1e8
