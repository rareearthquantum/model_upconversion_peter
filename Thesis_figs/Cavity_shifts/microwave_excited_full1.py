...
filename='Thesis_figs/Cavity_shifts/microwave_full_excited_shift3'
#I_vals=np.linspace(7.43,7.55,31)
delta2vals=np.linspace(-2000e6,2000e6,20)
deltamucvals=np.linspace(-150e6,150e6,15)/10
delta2vals=np.linspace(-2000e6,2000e6,125)
deltamucvals=np.linspace(-250e6,250e6,125)/100
...
def fields_vec_fun(fields_vec,ainval,binval,deloval,delmval,delocval,delmucval,p):
    ...
    rho=np.array(rho_broad_full(0,bval,deloval,delmval,p))
