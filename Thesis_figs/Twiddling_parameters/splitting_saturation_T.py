...
filename='Thesis_figs/Double_cavityawfe/aqwfgGround_crossing2'
...
def omegaao_from_B(B_mag,p): #transition 2
...
def deltaao_from_B(B_mag,p):
    return -(2*pi*(p['freqmu']+p['freq_pump'])-omegaao_from_B(B_mag,p))
...
T_vals=np.linspace(0,1000,5)*1e-3
