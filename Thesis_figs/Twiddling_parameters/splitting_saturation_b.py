...
filename='Thesis_figs/Double/Ground_bin_test'
...
deltamvals=np.linspace(-40e6,40e6,13)*2*np.pi
...
binvals=np.linspace(bin_from_PdBm(-45.9,p),bin_from_PdBm(-30.9,p),11)#*1e7#bin_from_PdBm(P_mu,p)
