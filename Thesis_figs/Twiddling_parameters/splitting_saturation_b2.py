...
P_mu = -47.9 # in dBm
T=150e-3
filename='Thesis_figs/Twiddling_parameters/splitting_saturation_b2_out_testpower'
...
for ii, binval in enumerate(binvals):
    p['mean_delam']=0e7#deltamac_from_I(B_val,p)
    p['nbath']=nbath_from_T(T,p,deltamacval=p['mean_delam'])
    p['mean_delao']=2e6*0#deltaao_from_I(B_val,p)*0
