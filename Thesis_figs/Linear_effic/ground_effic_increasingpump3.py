...
for ii,Pump_val in enumerate(Pump_vals):
    ...
    #         effic_result2gamma=scipy.optimize.minimize(effic_fun2_gamma,x_init,args=(p),method='TNC',bounds=x_bounds_gamma,options = {'maxiter' : 400})
    #         print(effic_fun2_gamma(effic_result2gamma.x,p))
    #         print(effic_result2gamma)
    #         if not np.isnan(effic_result2gamma.fun):
    #             x_init=effic_result2gamma.x
    ...
    effic_result6=scipy.optimize.minimize(effic_fun6,x_init,args=(p),bounds=x_bounds6,method='TNC',options = {'maxiter' : 400})
    print(effic_result6)
    # if not np.isnan(effic_result6.fun):
    #     x_init=effic_result6.x
    # effic_result6=scipy.optimize.minimize(effic_fun6,x_init,args=(p),bounds=x_bounds6,method='L-BFGS-B',options = {'maxiter' : 200})
    # print(effic_result6)
    # if not np.isnan(effic_result6.fun):
    #     x_init=effic_result6.x
    # effic_result6=scipy.optimize.minimize(effic_fun6,x_init,args=(p),bounds=x_bounds6,method='TNC',options = {'maxiter' : 400})
    ...
    np.savez('Thesis_figs/Linear_effic/increasingpump3_test2_lowgammi_N'+str(N/1e15)+'',x_found6=x_found6,fun_found6=fun_found6,p=p,Pump_vals=Pump_vals,
