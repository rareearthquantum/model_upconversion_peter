...
# Pump_vals=[100,1000]
Pump_vals=np.linspace(1,100,21)

Pump_vals=[50,75,100,125,150,175]
Pump_vals=[200,225,250,275,300,350]
...
filename_in='Thesis_figs/Linear_effic/increasingpump3_test2_N10.0MORE3big'

npzfile=np.load(filename_in+'.npz')
p=npzfile['p'][()]
Pump_vals_in=npzfile['Pump_vals']
x_found_in=npzfile['x_found6MORE']
spl1=scipy.interpolate.UnivariateSpline(Pump_vals_in,x_found_in[0,:])
spl2=scipy.interpolate.UnivariateSpline(Pump_vals_in,x_found_in[1,:])
spl3=scipy.interpolate.UnivariateSpline(Pump_vals_in,x_found_in[2,:])
spl4=scipy.interpolate.UnivariateSpline(Pump_vals_in,x_found_in[3,:])
spl5=scipy.interpolate.UnivariateSpline(Pump_vals_in,x_found_in[4,:])
spl6=scipy.interpolate.UnivariateSpline(Pump_vals_in,x_found_in[5,:])

name_add='spline_200_350'
for ii,Pump_val in enumerate(Pump_vals):
    p['Omega']=Omega_cavity_from_PdBm_resonance(10*np.log10(Pump_val),p)
    print(Pump_val)
    x_init6= x_found6[:,ii]
    x_init6=[spl1(Pump_val),spl2(Pump_val),spl3(Pump_val),spl4(Pump_val),spl5(Pump_val),spl6(Pump_val)]
    x_init=x_init6
