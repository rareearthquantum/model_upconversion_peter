...
Pump_vals=[1,3,5,10]
delta2starts=np.array([-1e9,-2.5e9,-3.5e9,-5e9])
delta3starts=np.array([-6e9,-6e9,-6e9,-6e9])
...
filename='Thesis_figs/Linear_effic/increasingpump_excited1new_test2_N'+str(N/1e15)+''
for ii,Pump_val in enumerate(Pump_vals):
    ...
    np.savez(filename,x_found6=x_found6,fun_found6=fun_found6,p=p,Pump_vals=Pump_vals,
