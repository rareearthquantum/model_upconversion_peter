...
fun_found2gamma=np.zeros((len(Pump_vals)))
...
filename='Thesis_figs/Linear_effic/increasingpump_excited1_test12_Nss'+str(N/1e15)+''
for ii,Pump_val in enumerate(Pump_vals):
    ...
    fun_found2gamma[ii]=effic_result2gamma.fun
    ...
    # if not np.isnan(effic_result6.fun):
    #     x_init=effic_result6.x
    # effic_result6=scipy.optimize.minimize(effic_fun6big,x_init,args=(p),bounds=x_bounds6,method='TNC',options = {'maxiter' : 200})
    # print(filename)
    # print(effic_result6)
    ...
    np.savez(filename,x_found6=x_found6,fun_found6=fun_found6,p=p,Pump_vals=Pump_vals,fun_found2gamma=fun_found2gamma,
