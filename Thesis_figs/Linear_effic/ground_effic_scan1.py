...
filename='Linear_effic_test_sameN_'
...
delta2vals=np.linspace(-5e8,0e8,11)[:-1]
delta3vals=np.linspace(-8e10,-0e10,11)[:-1]
...
# p['gammamc']=0.8e9
# p['gammaoc']=0.7e10
filename='Thesis_figs/Linear_effic/effic_scan_1quads4'
