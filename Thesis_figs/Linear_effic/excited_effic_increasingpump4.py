...
import time
# from Linear_excited1.c_linear_excited1big import rho_broad_full
# from Linear_excited1.c_linear_excited1big import rho_broad_full as rho_broad_fullbig
from Linear_excited1.c_linear_excited1 import rho_broad_full
from Linear_excited1.c_linear_excited1 import rho_broad_full as rho_broad_fullbig
...
#x=[deloval,delmval,delocval,delmucval,mean_delao,mean_delao,gammaoc]
    ...
    p['gammamc']=x[5]*1e6
    p['Omega']=Omega_cavity_from_PdBm_resonance(10*np.log10(p['Pump_val']),p)
...
filename='Thesis_figs/Linear_effic/increasingpump_excited4small_test_N'+str(N/1e15)+''
for ii,Pump_val in enumerate(Pump_vals):
    ...
    fun_found2[ii]=effic_result2.fun
    ...
    x_init6= [p['No']*p['go']**2/(x_found2[0,ii]*1e10)*1e-10,0,x_found2[0,ii],x_found2[1,ii],x_init_gamma[0],x_init_gamma[1]]
    x_init=x_init6
    ...
    np.savez(filename,x_found6=x_found6,fun_found6=fun_found6,p=p,Pump_vals=Pump_vals,x_found2=x_found2,fun_found2=fun_found2)
