...
x_init5=[-1.74473306, -0.03468763, -1.96263225, -1.56618982, -3.03055228,
       -0.78115667,  5.57470461, 21.01507893]
...
x_init7=[-0.20483753, -0.94468276, -1.35354733, -1.14431014,  3.91142365,5.19283831, 1000.76086523]
# print(effic_fun_Ppump(x_init7,p))
# effic_result=scipy.optimize.basinhopping(effic_fun_Ppump,x_init7,minimizer_kwargs={"args":p,"bounds":x_bounds7})#,bounds=x_bounds7)
# print(effic_fun_Ppump(x_init5,p))
print(effic_fun_Ppump(x_init7,p))
effic_result=scipy.optimize.basinhopping(effic_fun_Ppump,x_init7,minimizer_kwargs={"args":p,"bounds":x_bounds7,"method":'TNC'})#,bounds=x_bounds7)
print('P_pump')
print(effic_result)
print(effic_fun_Ppump(effic_result.x,p))
effic_result=scipy.optimize.basinhopping(effic_fun_Ppump,effic_result.x.x,minimizer_kwargs={"args":p,"bounds":x_bounds7,"method":'L-BFGS-B'})#,bounds=x_bounds7)
print('P_pump')
print(effic_result)
print(effic_fun_Ppump(effic_result.x,p))
effic_result=scipy.optimize.basinhopping(effic_fun_Ppump,effic_result.x.x,minimizer_kwargs={"args":p,"bounds":x_bounds7,"method":'TNC'})#,bounds=x_bounds7)
print('P_pump')
print(effic_result)
print(effic_fun_Ppump(effic_result.x,p))
effic_result=scipy.optimize.basinhopping(effic_fun_Ppump,effic_result.x.x,minimizer_kwargs={"args":p,"bounds":x_bounds7,"method":'L-BFGS-B'})#,bounds=x_bounds7)
