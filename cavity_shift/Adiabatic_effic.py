...
#     effic=np.abs(1j*SS*np.sqrt(p['gammaoc']*p['gammamc'])/(np.abs(SS)**2+(-1j*(delmval-delmucval)+(p['gammami']+p['gammamc'])/2)*(-1j*(deloval-delocval)+(p['gammaoi']+p['gammaoc'])/2)))
#     Caa = (np.abs(SS)**2-(-1j*(delmval-delmucval)+(p['gammami']+p['gammamc'])/2)*(1j*(deloval-delocval)+(p['gammaoi']+p['gammaoc'])/2))/(np.abs(SS)**2+(-1j*(delmval-delmucval)+(p['gammami']+p['gammamc'])/2)*(-1j*(deloval-delocval)+(p['gammaoi']+p['gammaoc'])/2))
#     Cbb = (np.abs(SS)**2-(1j*(delmval-delmucval)+(p['gammami']+p['gammamc'])/2)*(-1j*(deloval-delocval)+(p['gammaoi']+p['gammaoc'])/2))/(np.abs(SS)**2+(-1j*(delmval-delmucval)+(p['gammami']+p['gammamc'])/2)*(-1j*(deloval-delocval)+(p['gammaoi']+p['gammaoc'])/2))
...
def calc_efficiency_adiabatic(deloval,delmval,delocval,delmucval,p):
    ...
    #good_val=1
    effic=np.abs(1j*SS*np.sqrt(p['gammaoc']*p['gammamc'])/(np.abs(SS)**2+(-1j*(delmval-delmucval)+(p['gammami']+p['gammamc'])/2)*(-1j*(deloval-delocval)+(p['gammaoi']+p['gammaoc'])/2)))**2
    Caa = p['gammaoc']*(-1j*(delmval-delmucval)+(p['gammami']+p['gammamc'])/2)/(np.abs(SS)**2+(-1j*(delmval-delmucval)+(p['gammami']+p['gammamc'])/2)*(-1j*(deloval-delocval)+(p['gammaoi']+p['gammaoc'])/2))
    Cbb = p['gammamc']*(-1j*(deloval-delocval)+(p['gammaoi']+p['gammaoc'])/2) /(np.abs(SS)**2+(-1j*(delmval-delmucval)+(p['gammami']+p['gammamc'])/2)*(-1j*(deloval-delocval)+(p['gammaoi']+p['gammaoc'])/2))
    return effic, Caa, Cbb,SS,good_val
