...
Pump_vals=np.concatenate((np.arange(1,5,0.5),np.arange(5,10,1),np.arange(10,20,2),np.arange(20,150,5),
                          np.arange(150,200,5),np.arange(200,300,10),np.arange(300,500,20),np.arange(500,1000,50)))
# Pump_vals=[1,2,3,4,5]
...
for ii,Pump_val in enumerate(Pump_vals):
    ...
    np.savez('Thesis_paper/increasingpump1_N'+str(N/1e15)+'_Q'+str(Q)+'big13',x_found=x_found,fun_found=fun_found,p=p,Pump_vals=Pump_vals,T=T)
    x_init=x_found[:,ii]
